...
UCLASS()
class NETWORKPROGRAMMING_API UFGMovementComponent : public UMovementComponent
{
	GENERATED_BODY()
public:
	...
	void SetFacingDirection(const FVector& InFacingRotatino, float InRotationSpeed = -1.0f);
